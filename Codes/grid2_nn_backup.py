...
# 	layer1_weights = init_weights(12,200)
# 	layer2_weights = init_weights(200,1)
...
def init_board():
	board_state = '0'*12
	layer1_weights = init_weights(24,80)
	layer2_weights = init_weights(80,1)
...
def check_reward(board_state,action_index,player):
	...
	if len(indices_list) == 12:
		game_complete_flag = 1

	for index in indices_to_check:
		box_indices = [index,index+3,index+5,index+2]
		counter = 0
	...
	if players_box_count[0]+players_box_count[1] == 4:
		game_complete_flag =1 
